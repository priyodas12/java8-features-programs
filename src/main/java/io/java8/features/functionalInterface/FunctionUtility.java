...
public class FunctionUtility {
  ...
  public static void main(String[] args) {
    ...
    Function<Integer, Integer[]> testFunctionArray = i -> IntStream.rangeClosed(0, i).boxed()
        .toArray(Integer[]::new);
    ...
    System.out.println(Arrays.toString(
        testFunction.andThen(testFunctionArray).apply("priyo")));//testFunction-> testFunctionArray

    System.out.println(Arrays.toString(
        testFunctionArray.compose(testFunction).apply("priyo")));//testFunctionArray->testFunction
  }
}
