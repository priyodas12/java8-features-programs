package io.java8.features.flatmap;
...
public class FlatMapImpl2 {
  ...
  public static void main(String[] args) {
    ...
    Arrays.asList("fabcd", "gbcah", "defk", "dfgs").stream().flatMap(x -> x.lines()).sorted()
        .forEach(System.out::println);
    Arrays.asList("abcd", "bcah", "defk", "dfgs").stream().flatMapToInt(x -> x.chars())
